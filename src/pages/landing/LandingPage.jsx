      ...
      <header className="lp-header">
        <div className="lp-header-inner">
          ...
          <nav className="lp-nav" aria-label="Primary navigation">
            ...
            <a className="lp-nav-link" href="#patients" onClick={(e) => { e.preventDefault(); handleGetStarted(); }}>For Patients</a>
            <a className="lp-nav-link" href="#hospitals" onClick={(e) => { e.preventDefault(); navigate('/role-select'); }}>For Hospitals</a>
